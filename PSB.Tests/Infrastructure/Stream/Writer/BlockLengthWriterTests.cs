...
namespace Psb.Tests.Infrastructure.Stream.Writer
{
    ...
    public class BlockLengthWriterTests
    {
        ...
        public void CompleteSequenceShouldWriteCorrectLength_WhenUsed(long startPosition, long endPosition, uint expectedLength)
        {
            // arrange
            ...
            // act
            using (var sut = Psb.Infrastructure.Stream.Writer.BlockLengthWriter.CreateBlockLengthWriter(binaryWriter.Object))
            {
